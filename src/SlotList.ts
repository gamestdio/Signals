...
export class SlotList {
     ...
     */
    constructor(head: Slot, tail: SlotList = null) {
        if (!head && !tail) {
            if (SlotList.NIL) {
     ...
     * @throws ArgumentError <code>ArgumentError</code>: Parameter head cannot be null.
     */
    public prepend(slot: Slot): SlotList {
     ...
     */
    public append(slot: Slot): SlotList {
        if (!slot) {
            return this;
        }
     ...
     * @throws ArgumentError <code>ArgumentError</code>: Parameter head cannot be null.
     */
    public insertWithPriority(slot: Slot): SlotList {
        if (!this.nonEmpty) {
            return new SlotList(slot);
        }
     ...
     * @return  The Slot in this list associated with the listener parameter through the Slot.listener property.
     *          Returns null if no such Slot instance exists or the list is empty.
     */
    public find(listener: Function): Slot {
        if (!this.nonEmpty) {
            return null;
        }
